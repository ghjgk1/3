        ...
        public static IHostBuilder CreateHostBuilder(string[] args) =>
            Host.CreateDefaultBuilder(args)
                ...
                .ConfigureServices((hostContext, services) =>
                {
                    ...
                    services.AddScoped<ISourceRepository>(provider =>
                    ...
                    services.AddSingleton<ITargetRepository>(provider =>
                    ...
                    services.AddScoped<SyncService>(provider =>
                        new SyncService(
                            provider.GetServices<ISourceRepository>().First(x => x is EfSyncRepository),
                            provider.GetServices<ITargetRepository>().First(x => x is LdapSyncRepository),
